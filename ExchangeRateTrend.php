...
// ************************
	...
	echo '<form autocomplete="off"method="post" id="update" action="' . htmlspecialchars($_SERVER['PHP_SELF'],ENT_QUOTES,'UTF-8') . '">';
    echo '<div>';
	...
	echo '<table class="table table-bordered">'; // First column
